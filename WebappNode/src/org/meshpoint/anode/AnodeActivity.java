...
//		});
	...
	private void startAction() {
		...
		initRuntime(opts);
		// String args = argsText.getText().toString(); //abre el de la caja de texto
...
//		String args = "/sdcard/test.js";
	...
	private void stopAction() {
		if (instance == null) {
			Log.v(TAG,
					"AnodeReceiver.onReceive::stop: no instance currently running for this activity");
			return;
		}
		try {
			isolate.stop();
			...
			Log.v(TAG,
					"isolate stop : exception: " + e + "; cause: "
							+ e.getCause());
		} catch (NodeException e) {
